...
class ConfigGPT:
    ...
    _JSON_SAMPLE = {
        ...
        "English": [
            ...
            TranslationList(
                TextList=[
                    TextValue(
                        ID=1,
                        text="I'm so embarrassed... I don't want to stand out... I want to disappear...",
                    ),
        ...
        "Korean": [
            ...
            TranslationList(
                TextList=[
                    TextValue(
                        ID=1, text="부끄러워... 눈에 띄고 싶지 않아... 나 숨고 싶어..."
                    ),
    ...
    def _closest_sample_match(
        self, all_samples: Dict, to_lang: str, max_distance=5
    ) -> List:
        """
    ...
    def glossary_system_template(self) -> str:
        return self._config_get(
            "glossary_system_template", self._GLOSSARY_SYSTEM_TEMPLATE
        )
