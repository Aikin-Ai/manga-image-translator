...
OPENAI_GLOSSARY_PATH = os.getenv(
    "OPENAI_GLOSSARY_PATH", "./dict/mit_glossary.txt"
)  # OpenAI术语表路径
OPENAI_API_BASE = os.getenv(
    "OPENAI_API_BASE", "https://api.openai.com/v1"
)  # 使用api-for-open-llm例子 http://127.0.0.1:8000/v1

# sakura
SAKURA_API_BASE = os.getenv(
    "SAKURA_API_BASE", "http://127.0.0.1:8080/v1"
)  # SAKURA API地址
SAKURA_VERSION = os.getenv(
    "SAKURA_VERSION", "0.9"
)  # SAKURA API版本，可选值：0.9、0.10，选择0.10则会加载术语表。
SAKURA_DICT_PATH = os.getenv(
...
CUSTOM_OPENAI_API_KEY = os.getenv(
    "CUSTOM_OPENAI_API_KEY", "ollama"
)  # Unsed for ollama, but maybe useful for other LLM tools.
CUSTOM_OPENAI_API_BASE = os.getenv(
    "CUSTOM_OPENAI_API_BASE", "http://localhost:5001/v1"
)  # Use OLLAMA_HOST env to change binding IP and Port.
CUSTOM_OPENAI_MODEL = os.getenv(
    "CUSTOM_OPENAI_MODEL", ""
)  # e.g "qwen2.5:7b". Make sure to pull and run it before use.
